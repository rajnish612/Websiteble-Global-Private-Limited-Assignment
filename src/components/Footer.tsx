...
const Footer = () => {
  return (
    <div className="bg-[#D7EEDD] pb-10 flex flex-col mt-40 w-full">
      {/* footer part 1 */}
      <div className="flex max-w-[90%] justify-start flex-wrap-reverse   relative items-center mx-auto w-full ">
        <div className="flex sm:max-w-[70%] w-full    z-10 lg:max-w-[50%] mx-auto  justify-center px-10  flex-col gap-y-6 items-center">
          ...
          <img src="/public/images/Subscribe to our newsletter.png" />
      ...
      <div className="flex flex-col gap-y-20 items-center">
        <div className="max-w-[90%] mt-20 border-t border-black pt-15 grid sm:grid-cols-2 text-center sm:text-left gap-y-8 grid-cols-1  lg:grid-cols-4 mx-auto w-full">
          ...
          <div className=" flex flex-col gap-y-2">
            <span className="font-bold">Terms & Policies</span>
            <ul className="flex flex-col gap-y-4">
              <li>498w Fluton ste, STE 2D Chicgo, IL 63867. </li>
              <li>(123) 456789000</li>
              <li>info@elementum.com</li>
            </ul>
          </div>
        </div>
        <span className="px-5 ">2023 Elementum. All rights reserved</span>
      </div>
    </div>
  );
};
