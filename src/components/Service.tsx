...
const Service = () => {
  return (
    <div className="w-full relative   gap-y-6 flex flex-col mt-40">
      {/* part1 */}
      <div className="sm:max-w-[90%]  px-5   gap-y-6   justify-start items-center flex w-full mx-auto ">
        ...
        <div className="max-w-[50%]  min-w-60 h-fit  bg-amber-400   relative  flex justify-center items-center w-full"></div>
        {/*curve line svg */}
        <svg
